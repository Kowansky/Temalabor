...
/**
 * This is the item provider adapter for a {@link football.Country} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CountryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FootballPackage.Literals.COUNTRY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FootballPackage.Literals.COUNTRY__CHAMPIONS);
			childrenFeatures.add(FootballPackage.Literals.COUNTRY__CUPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FootballPackage.Literals.COUNTRY__CHAMPIONS,
				 FootballFactory.eINSTANCE.createChampionship()));

		newChildDescriptors.add
			(createChildParameter
				(FootballPackage.Literals.COUNTRY__CUPS,
				 FootballFactory.eINSTANCE.createCup()));
	}
