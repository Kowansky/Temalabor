...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>football</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FootballExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.football"));
				Country root = FootballFactory.eINSTANCE.createCountry();
