 ...
 * </p>
 * <ul>
 *   <li>{@link football.impl.ChampionshipImpl#getName <em>Name</em>}</li>
 *   <li>{@link football.impl.ChampionshipImpl#getTeams <em>Teams</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChampionshipImpl extends MinimalEObjectImpl.Container implements Championship {
	...
	protected EClass eStaticClass() {
		return FootballPackage.Literals.CHAMPIONSHIP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FootballPackage.CHAMPIONSHIP__NAME, oldName, name));
	}
	...
	public EList<Team> getTeams() {
		if (teams == null) {
			teams = new EObjectContainmentEList<Team>(Team.class, this, FootballPackage.CHAMPIONSHIP__TEAMS);
		}
		return teams;
	}
