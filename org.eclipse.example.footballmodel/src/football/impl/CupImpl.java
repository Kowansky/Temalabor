 ...
 * </p>
 * <ul>
 *   <li>{@link football.impl.CupImpl#getName <em>Name</em>}</li>
 *   <li>{@link football.impl.CupImpl#getTeams <em>Teams</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CupImpl extends MinimalEObjectImpl.Container implements Cup {
	...
	protected EClass eStaticClass() {
		return FootballPackage.Literals.CUP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FootballPackage.CUP__NAME, oldName, name));
	}
	...
	public EList<Team> getTeams() {
		if (teams == null) {
			teams = new EObjectContainmentEList<Team>(Team.class, this, FootballPackage.CUP__TEAMS);
		}
		return teams;
	}
