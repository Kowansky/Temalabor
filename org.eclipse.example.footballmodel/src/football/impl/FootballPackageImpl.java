...
public class FootballPackageImpl extends EPackageImpl implements FootballPackage {
	...
	public static FootballPackage init() {
		...
		FootballPackageImpl theFootballPackage = (FootballPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FootballPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FootballPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getCountry_Champions() {
	 ...
	 * @generated
	 */
	public EReference getCountry_Cups() {
	 ...
	 * @generated
	 */
	public EReference getChampionship_Teams() {
		return (EReference)championshipEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getCup_Teams() {
	 ...
	 * @generated
	 */
	public EAttribute getTeam_City() {
	 ...
	 * @generated
	 */
	public EAttribute getTeam_Manager() {
	 ...
	 * @generated
	 */
	public EAttribute getTeam_StadiumName() {
	...
	public void createPackageContents() {
		...
		createEReference(countryEClass, COUNTRY__CHAMPIONS);
		createEReference(countryEClass, COUNTRY__CUPS);

		championshipEClass = createEClass(CHAMPIONSHIP);
		createEAttribute(championshipEClass, CHAMPIONSHIP__NAME);
		createEReference(championshipEClass, CHAMPIONSHIP__TEAMS);

		cupEClass = createEClass(CUP);
		createEAttribute(cupEClass, CUP__NAME);
		createEReference(cupEClass, CUP__TEAMS);

		teamEClass = createEClass(TEAM);
		createEAttribute(teamEClass, TEAM__NAME);
		createEAttribute(teamEClass, TEAM__CITY);
		createEAttribute(teamEClass, TEAM__MANAGER);
		createEAttribute(teamEClass, TEAM__STADIUM_NAME);
	...
	public void initializePackageContents() {
		...
		initEReference(getCountry_Champions(), this.getChampionship(), null, "champions", null, 1, -1, Country.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCountry_Cups(), this.getCup(), null, "cups", null, 1, -1, Country.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getChampionship_Teams(), this.getTeam(), null, "teams", null, 1, 20, Championship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(cupEClass, Cup.class, "Cup", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCup_Name(), ecorePackage.getEString(), "name", null, 0, 1, Cup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCup_Teams(), this.getTeam(), null, "teams", null, 1, 16, Cup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTeam_City(), ecorePackage.getEString(), "city", null, 0, 1, Team.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTeam_Manager(), ecorePackage.getEString(), "manager", null, 0, 1, Team.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTeam_StadiumName(), ecorePackage.getEString(), "stadiumName", null, 0, 1, Team.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
